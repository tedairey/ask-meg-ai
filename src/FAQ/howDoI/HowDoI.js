    ...
    return (
        <div id="how-do-i">
            ...
            <div className="question">
                ...
                <p>Please email
                    <a href="mailto:subscriptions@askmeg.ai" class="email"> subscriptions@askmeg.ai</a>
                </p>
            </div>
            <div className="question">
            ...
            <div className="question">
                ...
                <p>
                    ...
                    <a href="mailto:support@askmeg.ai" class="email">support@askmeg.ai</a> 
            ...
            <div className="question">
                ...
                <p>
                    ...
                    my exercise”. You can also tap the analysis icon and see your data as a table and in a 
                    chart for the last few days.
                </p>
            </div>
            <div className="question">
                <h4>Log activity</h4>
                <p>
                    ...
                    morning” and Meg will ask you to confirm it.
                </p>
            </div>
            <div className="question">
                <h4>Log food</h4>
                <p>
                    ...
                    island dressing for dinner tonight” and Meg will confirm and log it. Or, you can 
                    scan a food’s UPC code and after Meg has told you about it, say “log it” and 
                    Meg will guide you through the steps to log the food.
                </p>
            </div>
            <div className="question">
                <h4>Log weight</h4>
            ...
            <div className="question">
                ...
                <p>
                    ...
                    describe your weight progress. “How am I doing with my nutrition” or “…calories” 
                    or “… exercise” works the same way.
                </p>
            </div>
            <div className="question">
            ...
            <div className="question">
                ...
                <p>Meg tracks the calories you consume on an ongoing basis. She also calculates 
                    ...
                    this a calorie deficit. Conversely, where you consume more calories than you 
                    burn, we call this a calorie surplus. You can see your data tapping the analysis icon.
                </p>
            </div>
            <div className="question">
                ...
                <p>
                    ...
                    a ready state and be listening for your next sentence. If she doesn’t seem to wake, 
                    tap the microphone icon to make it live and talk or text her.
                </p>
            </div>
        </div>
    );
