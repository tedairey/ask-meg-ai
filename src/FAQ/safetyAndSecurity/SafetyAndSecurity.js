        ...
        <div id="safety-and-security">
            ...
            <div className="question">
                ...
                <p>
                    ...
                    and the baby are getting enough nourishment. Also, Meg isn’t specifically created 
                    to address questions related to breast feeding, like “should I drink alcohol?” or 
                    “will eating nuts increase the risk of my baby developing a nut allergy?” Questions 
                    like these are best posed to your pediatrician. The good news is that Meg can guide 
                    you regarding healthy eating, and that’s good for your entire family!
                </p>
            </div>
            <div className="question">
                ...
                <p>
                    ...
                    to the plan by your health care provider should be followed.    
                </p>
            </div>
            <div className="question">
